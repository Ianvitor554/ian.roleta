# -*- coding: utf-8 -*-
"""
IR PREDICTOR 360 WEB LIVE V5 - LABORATÓRIO DE ESTRATÉGIAS
Pydroid 3 / Android
...
HISTORY_FILE = os.path.join(DATA_DIR, "ir_v5_history.json")
LEARNING_FILE = os.path.join(DATA_DIR, "ir_v5_learning.json")

MAX_HISTORY = 30000
UPSTREAM_MIN_INTERVAL = 6.0
...
<title>IR Predictor 360 V3</title>
<style>
:root{
...
if __name__ == "__main__":
    ...
    print("=" * 62)
    print("IR PREDICTOR 360 • STRATEGY LAB V5 • AUTO-LEARNING")
    ...
    try:
        ...
        print("Aviso: não foi possível atualizar a API no arranque:", exc)
